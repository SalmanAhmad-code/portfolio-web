...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-background-darker py-12 border-t border-gray-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="md:col-span-2">
            ...
            <p className="text-gray-400 mb-6 max-w-md">
              Building exceptional digital experiences with modern technologies and a focus on clean, efficient code.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#about" className="text-gray-400 hover:text-accent-400 transition-colors duration-300">About</a>
              </li>
              <li>
                <a href="#skills" className="text-gray-400 hover:text-accent-400 transition-colors duration-300">Skills</a>
              </li>
              <li>
                <a href="#projects" className="text-gray-400 hover:text-accent-400 transition-colors duration-300">Projects</a>
              </li>
              <li>
                <a href="#resume" className="text-gray-400 hover:text-accent-400 transition-colors duration-300">Resume</a>
              </li>
              <li>
                <a href="#contact" className="text-gray-400 hover:text-accent-400 transition-colors duration-300">Contact</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start space-x-3">
                <svg className="h-5 w-5 text-accent-glow mt-0.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
              ...
              <li className="flex items-start space-x-3">
                ...
                <span className="text-gray-400">salmanahmadyt@gmail.com</span>
              </li>
              <li className="flex items-start space-x-3">
                <svg className="h-5 w-5 text-accent-glow mt-0.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                  <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                </svg>
                <span className="text-gray-400">+92 319 1722875</span>
              </li>
            </ul>
          </div>
        </div>

        <div className="gradient-line w-full my-8"></div>

        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm mb-4 md:mb-0">
            &copy; {currentYear} Salman Ahmad. All Rights Reserved.
          </p>
          ...
          <motion.button
            ...
            whileHover={{ y: -3 }}
            whileTap={{ y: 0 }}
            className="p-3 bg-accent-900/20 rounded-full text-accent-glow hover:bg-accent-900/40 transition-colors duration-300"
